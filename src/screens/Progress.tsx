...
import { Target, RotateCcw, Trophy, Copy, Check, Download, X } from 'lucide-react';
      ...
      >
        <div className="px-4 space-y-8">
          ...
          <div className="relative z-10">
            ...
            <p className="m3-title-medium opacity-90 mb-6">Words Learned</p>
            
            <div className="w-full bg-on-primary/20 rounded-full h-3 mb-2 overflow-hidden">
              <motion.div 
                initial={{ width: 0 }}
            ...
            <p className="m3-label-medium opacity-80 text-right">{percentage}% of total vocabulary</p>
          </div>
        ...
        <section className="bg-surface rounded-3xl p-6 shadow-sm border border-outline/10">
          <div className="flex items-center mb-6 text-on-surface">
            ...
            <h2 className="m3-title-large">Learning Goals</h2>
          </div>
          ...
          <div className="space-y-6">
            <div>
              <label className="flex justify-between items-center">
                <div>
                  <p className="m3-body-large text-on-surface">Daily Goal</p>
                  <p className="m3-body-small text-on-surface-variant">Words to learn per day</p>
                </div>
                <select
